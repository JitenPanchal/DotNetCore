...
namespace DotNetCore.Database.Mappings
{
    public partial class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(x => x.PasswordSalt).HasColumnName(@"PasswordSalt").HasColumnType("nvarchar(128)").IsRequired().HasMaxLength(128);
            ...
            builder.Property(x => x.Token).HasColumnName(@"Token").HasColumnType("nvarchar(128)").IsRequired(false).HasMaxLength(128);
